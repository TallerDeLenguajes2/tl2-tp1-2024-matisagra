...
class Program
{
    static void Main(string[] args)
    {
        ...
        if (opcionArchivo == 1){
            ...
            cadeteria.ListadoCadetes1 = archivoJson.LeerCadetes("cadetes.json");

        }
        if (opcionArchivo == 2){
            cadeteria = archivoCvs.LeerCadeteria("cadeteria.csv");
            cadeteria.ListadoCadetes1 = archivoCvs.LeerCadetes("cadetes.csv");
        } 
    ...
    static void MostrarInforme(Cadeteria cadeteria)
    {
        ...
        var informeCadetes = cadeteria.ListadoCadetes1.Select(c => new
        {
            Cadete = c,
